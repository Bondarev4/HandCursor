...
4. [🖥️ Установка (not yet)](#️-установка)
5. [🎮 Использование (not yet)](#-использование)
6. [📚 Техническая документация](docs/documentation.md)
7. [📁 Структура проекта](#-структура-проекта)
8. [🧪 Тестирование (not yet)](#-тестирование)
10. [🗓️ Планы развития (not yet)](#-планы-развития)
11. [📈 Диаграммы для проекта (TEMPORARY)](docs/diagrams.md)
---
